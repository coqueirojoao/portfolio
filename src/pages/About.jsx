        ...
        <div className='mx-3 xl:mx-auto mt-24 border xl:w-3/4 bg-gray-300 rounded shadow-lg shadow-black'>
          <div className='flex flex-col xl:flex-row justify-evenly items-center py-3'>
            ...
            <div className='xl:w-1/3 text-justify w-72 mt-5'>
              Me chamo <strong>João Pedro Coqueiro de Azevedo</strong>, tenho 27
              anos e sou nascido e residente no estado da Bahia.
              <br />
              Tenho bacharel em Direito, provido pela UniFTC, e atualmente estou
              estudando na escola de programação da{' '}
              <a
              ...
              <p className='mt-4'>
                Alem das minhas skills baseadas em programação, também posso dar
                um destaque nas minhas soft-skills.
                <br />
